...
- Apply fix-* scripts for each failure class identified
- Re-run affected audit gates after each repair
- Follow PIKEPDF_USAGE_RULE if pikepdf is needed
- Follow ALT_TEXT_RULE for Figure element failures
